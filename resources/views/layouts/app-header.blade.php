<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Barra de búsqueda — abre Command Palette (solo desktop) -->
            <button
                type="button"
                @click="$dispatch('abrir-palette')"
                class="hidden xl:flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-400 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-500 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
                ...
                <kbd class="hidden sm:inline-flex items-center gap-0.5 rounded border border-gray-300 bg-white px-1.5 py-0.5 text-xs text-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400">
    ...
    <!-- Command Palette Livewire Component -->
