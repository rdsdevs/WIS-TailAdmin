...
@section('content')
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Importar colaboradores</h2>
            <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                Cargue un archivo Excel o CSV para registrar colaboradores de forma masiva.
            </p>
        </div>
        <nav aria-label="Migas de pan">
            <ol class="flex items-center gap-1.5">
                ...
                <li>
                    <a href="{{ route('rh.colaboradores.index') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                        Colaboradores
                        <svg class="h-4 w-4 stroke-current" viewBox="0 0 17 16" fill="none" aria-hidden="true"><path d="M6.0765 12.667L10.2432 8.50033L6.0765 4.33366" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" /></svg>
                    </a>
                </li>
    ...
    <livewire:rh.collaborator-import />
