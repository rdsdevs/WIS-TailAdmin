...
<div class="space-y-6">
    ...
    <div>
        ...
        <div class="flex flex-wrap gap-3">
            ...
            @endphp
            @if($tieneActivos)
            {{-- Grupo de accesos rápidos: contractor-manager (3 botones con btn-primary) --}}
            @if($role === 'contractor-manager')
            <div class="flex divide-x divide-white/20 overflow-hidden rounded-xl shadow-sm">

                {{-- Colaboradores --}}
                <a href="{{ route('rh.colaboradores.index') }}"
                   class="btn-primary flex items-center gap-2.5 px-4 py-2.5 text-sm font-medium text-white transition-all hover:opacity-90">
                    Colaboradores
                    <span class="text-xs text-white/60">— Contratistas</span>
                    <svg class="h-4 w-4 shrink-0 text-white/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                    </svg>
                </a>
