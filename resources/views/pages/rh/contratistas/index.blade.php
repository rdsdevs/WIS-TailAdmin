...
@section('content')
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Contratistas</h2>
        <nav aria-label="Migas de pan">
            <ol class="flex items-center gap-1.5">
                ...
                <li class="text-sm font-medium text-gray-800 dark:text-white/90">Contratistas</li>
            </ol>
        </nav>
    </div>
