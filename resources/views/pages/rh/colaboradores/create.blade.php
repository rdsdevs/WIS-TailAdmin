...
@section('content')
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Registrar colaborador</h2>
            <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                Complete los datos para registrar un nuevo colaborador de ASCUN.
            </p>
        </div>
