...
<div class="space-y-6">
    ...
    @if(in_array($role, ['super-admin', 'admin']))
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Instituciones</p>
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Usuarios del sistema</p>
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Colaboradores</p>
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Contratos totales</p>
    ...
    @elseif(in_array($role, ['rh-manager', 'rh-viewer']))
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Contratos vigentes</p>
    ...
    @elseif($role === 'contractor-manager')
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Contratistas activos</p>
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Por vencer (30 días)</p>
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Contratos terminados</p>
    ...
    @elseif($role === 'employee-manager')
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex h-11 w-11 items-center justify-center rounded-full bg-teal-100 dark:bg-teal-900/30">
                ...
                <p class="mt-1 text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Empleados activos</p>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Contratos vigentes</p>
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Por vencer (30 días)</p>
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Contratos terminados</p>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Vigentes ({{ $tipoLabel }})</p>
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $metrics['vigentes'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Por vencer ({{ $tipoLabel }})</p>
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $metrics['por_vencer'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">Terminados ({{ $tipoLabel }})</p>
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $metrics['terminados'] }}</p>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="{{ route('rh.colaboradores.index') }}"
               class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700/50">
                ...
                <svg class="ml-auto h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18 6-6-6-6"/></svg>
            </a>
            @endif
            ...
            <a href="{{ route('rh.contratos.index') }}"
               class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700/50">
                <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    </svg>
                </div>
            ...
            <a href="{{ route('rh.departamentos.index') }}"
               class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700/50">
                <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-indigo-100 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                    </svg>
                </div>
            ...
            <a href="{{ route('rh.cargos.index') }}"
               class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700/50">
                <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-teal-100 text-teal-600 dark:bg-teal-900/30 dark:text-teal-400">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
            ...
            {{-- Módulos próximos (fundidos en el mismo grid) --}}
            @foreach($modulosProximos as $modulo)
            <div class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium opacity-60 cursor-not-allowed pointer-events-none dark:border-gray-700 dark:bg-gray-800">
                <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gray-100 text-gray-400 dark:bg-gray-700 dark:text-gray-500">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <span class="text-gray-400 dark:text-gray-500">{{ $modulo }}</span>
                <span class="ml-auto text-xs text-gray-400 italic dark:text-gray-500">Pronto</span>
            </div>
            @endforeach
