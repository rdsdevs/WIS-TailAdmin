...
@section('content')
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Editar cargo</h2>
            <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                Modifique los datos del cargo <strong class="font-semibold text-gray-700 dark:text-gray-300">{{ $cargo->name }}</strong>.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('rh.cargos.update', $cargo) }}"
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="flex items-start gap-4 rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/30">
                                    <label class="relative inline-flex cursor-pointer items-center flex-shrink-0 mt-0.5">
                                        <input type="hidden" name="is_active" value="0">
                                        <input type="checkbox" id="is_active" name="is_active" value="1"
                                               {{ old('is_active', $cargo->is_active) ? 'checked' : '' }}
                                               class="peer sr-only">
                                        <div class="peer h-6 w-11 rounded-full bg-gray-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:shadow-sm after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-500/30 dark:bg-gray-600 dark:after:border-gray-500"></div>
                                    </label>
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                                            Los cargos inactivos no aparecen disponibles al asignar empleados ni en reportes de estructura organizacional.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="space-y-5">
                    ...
                    {{-- Card: Información contextual --}}
                    <div class="rounded-2xl border border-amber-100 bg-amber-50 p-5 dark:border-amber-900/40 dark:bg-amber-900/10">
                        <div class="flex items-start gap-3">
                            <span class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-amber-500 dark:bg-amber-600">
                                <svg class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </span>
                            <div>
                                <h4 class="text-sm font-semibold text-amber-800 dark:text-amber-300">Editando cargo</h4>
                                <p class="mt-1 text-xs text-amber-700 dark:text-amber-400 leading-relaxed">
                                    Los cambios afectarán a todos los empleados vinculados a este cargo. Verifique antes de guardar.
                                </p>
                            </div>
                        </div>
                    </div>
